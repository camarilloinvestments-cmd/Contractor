...
import { Building2, Mail, FileText, ScrollText } from 'lucide-react';
    ...
    <div className="p-6 space-y-6">
      <FadeIn>
        <div>
          ...
          <p className="text-muted-foreground">Company branding, email delivery, templates, and delivery logs</p>
        </div>
      </FadeIn>
